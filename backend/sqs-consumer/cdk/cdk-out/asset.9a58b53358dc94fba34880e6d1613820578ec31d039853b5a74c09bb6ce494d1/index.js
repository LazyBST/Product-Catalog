        ...
        if (messageBody.Records && messageBody.Records[0] && messageBody.Records[0].s3) {
          ...
          if (keyParts.length < 2) {
            ...
            await updateDatabase(dbConfig, {
              ...
              total_batches: 0,
              processed_batches: 0,
              error: 'Invalid object key format. Expected format: company_id/product_list_id/filename.csv'
            });
          ...
          if (isNaN(company_id) || isNaN(product_list_id)) {
            console.error('[ERROR] Invalid company_id or product_list_id in object key. Both should be numeric.');
            ...
            await updateDatabase(dbConfig, {
              ...
              total_batches: 0,
              processed_batches: 0,
              error: 'Invalid company_id or product_list_id in object key. Both should be numeric.'
            });
          ...
          try {
            ...
            const csvStream = fs.createReadStream(localFilePath)
              ...
              .on('headers', (headers) => {
                ...
                if (!headersValid) {
                  ...
                  processingError = 'Invalid CSV headers. Expected: Product Name,Image Url,Brand,Barcode';
            ...
            await pipeline(
              ...
              processingError = processingError || `Error processing CSV: ${err.message}`;
              throw err;
            });
            ...
            if (rowsAfterRefining === 0) {
              processingError = 'No valid rows found in the CSV file after refinement';
